...
class Teacher extends Employee {
    ...
    void display() {
        ...
        System.out.println("Empid : " + this.empid + " company_name : " + this.company_name + " Salary : " + this.salary
                + " Address : " + this.address + " qualification : " + this.qualification);
        System.out.println("...Teacher's details...");
        System.out.println(
                " teacherid : " + this.teacherid + " department : " + this.department + " Subjects : " + this.subject);
    }
}
